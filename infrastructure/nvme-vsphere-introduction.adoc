...
In collaborazione con: image:cisco logo.png[""]
...
image:nvme-vsphere-image1.png["Un diagramma che mostra lo storage FlexPod, gli switch e le famiglie di componenti Cisco UCS con le serie di prodotti supportate"]
