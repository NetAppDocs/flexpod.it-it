...
image:sm-bcs-image20.png["Un diagramma che mostra FI 6454, Nexus e AFF A250 con connettività locale ridondante"]
...
image:sm-bcs-image21.png["Un diagramma che mostra i collegamenti peer vPC e i collegamenti inter-sito tra gli switch FlexPod dei siti A e B"]
