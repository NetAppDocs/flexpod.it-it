...
image:sm-bcs-image2.png["Un diagramma che mostra i componenti di FlexPod Datacenter: Cisco UCS, switch Nexus/MDS e storage NetApp AFF/FAS/ASA"]
...
image:sm-bcs-image3.png["Un diagramma che mostra la replica sincrona SnapMirror e il failover automatico tra datacenter primario e secondario"]
