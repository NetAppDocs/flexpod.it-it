...
image:sm-bcs-image16.png["Un diagramma che mostra i siti FlexPod A e B collegati da relazioni estese di Livello 2 e SM-BC con ONTAP Mediator nel sito C"]
