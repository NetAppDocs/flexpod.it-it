...
image:sm-bcs-image17.png["Un diagramma che mostra UCS 2204XP A e B collegate a un B200 M5 VIC tramite 10GBASE-KR"]
...
image:sm-bcs-image18.png["Un diagramma che mostra i moduli IOM UCS 5108 collegati agli switch FI 6454 e agli switch Nexus A e B"]
...
image:sm-bcs-image19.png["Uno screenshot che mostra la finestra di dialogo Set iSCSI Boot Parameters di Cisco UCS Manager con due target statici configurati"]
