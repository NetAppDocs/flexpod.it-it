...
image:sm-bcs-image47.png["Un diagramma che mostra i percorsi iSCSI di ESXi attraverso due fabric verso le LUN del gruppo di coerenza primario e di destinazione"]
...
image:sm-bcs-image48.png["Uno screenshot della scheda Percorsi degli adattatori di archiviazione di ESXi che mostra due percorsi attivi (I/O) e sei percorsi iSCSI attivi"]
...
image:sm-bcs-image49.png["Uno screenshot del vSphere Client che mostra sei datastore iSCSI montati sull'host esxi-a-01.nva.local"]
...
image:sm-bcs-image50.png["Uno screenshot della selezione dello storage di migrazione di vSphere per iometer-a-01 con datastore iSCSI dai siti A e B"]
...
+
image:sm-bcs-image51.png["Uno screenshot di ONTAP System Manager Relationships con il menu delle opzioni di origine che mostra Failover"]

. Confermare il failover per l'avvio dell'azione.
+
image:sm-bcs-image52.png["Uno screenshot della conferma di failover pianificato di ONTAP System Manager per cg_esxi_a da Infra-SVM.1 a Infra-SVM-b"]
...
image:sm-bcs-image53.png["Uno screenshot di ONTAP System Manager che mostra i grafici delle prestazioni del sito A con IOPS e throughput ridotti"]
...
image:sm-bcs-image54.png["Uno screenshot della dashboard di ONTAP System Manager che mostra le prestazioni a 132,99K IOPS e 1.038,58 MB/s di throughput"]
...
image:sm-bcs-image55.png["Uno screenshot di ONTAP System Manager Relationships che mostra gruppi di coerenza integri e sincronizzati e un'opzione di menu Failover"]
...
image:sm-bcs-image56.png["Un diagramma che mostra l'indisponibilità dello storage del Sito A e la continuazione dei servizi dati SM-BC presso il Sito B tramite ONTAP Mediator"]
...
image:sm-bcs-image57.png["Uno screenshot della dashboard di ONTAP System Manager che mostra 80,32k IOPS e 626,98 MB/s di throughput"]

image:sm-bcs-image58.png["Uno screenshot della dashboard di ONTAP System Manager per aff-a250-b che mostra 81,37k IOPS e 635,41 MB/s di throughput"]
...
image:sm-bcs-image59.png["Uno screenshot di ONTAP System Manager che mostra un netto aumento di IOPS e throughput sul cluster aff-a250-b"]
...
image:sm-bcs-image60.png["Uno screenshot delle relazioni di ONTAP System Manager che mostra due relazioni sane non sincronizzate"]
...
image:sm-bcs-image61.png["Uno screenshot che mostra le relazioni di ONTAP System Manager con stato integro e stato sincronizzato"]
...
image:sm-bcs-image62.png["Uno screenshot della finestra di dialogo Modifica regola VM/host che assegna le VM del Sito A al gruppo di host del Sito B"]
...
image:sm-bcs-image63.png["Uno screenshot di due finestre BMC CLI che mostrano i comandi di spegnimento del sistema per aff-a250-a-01 e aff-a250-a-02"]
...
image:sm-bcs-image64.png["Uno screenshot di una dashboard di Grafana che mostra le metriche di latenza, throughput e IOPS per Infra-SVM sul cluster aff-a250-a"]

image:sm-bcs-image65.png["Uno screenshot della dashboard Grafana SVM che mostra i grafici di latenza, throughput e IOPS per Infra-SVM-b"]
...
image:sm-bcs-image66.png["Uno screenshot di Microsoft SQL Server TPROC-C Build Options con 100 warehouse e 10 utenti virtuali"]
...
image:sm-bcs-image67.png["Uno screenshot del contatore delle transazioni di HammerDB che mostra una breve interruzione e il successivo ripristino delle transazioni durante la creazione di TPROC-C"]
...
image:sm-bcs-image68.png["Uno screenshot della dashboard Grafana di NAbox che mostra la latenza, il throughput e le metriche IOPS del cluster di storage del sito B che scendono a zero"]
...
image:sm-bcs-image69.png["Uno screenshot della dashboard Grafana di NAbox che mostra la latenza, il throughput e le metriche IOPS della SVM del sito A"]
