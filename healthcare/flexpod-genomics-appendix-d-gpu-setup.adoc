...
+
image:flexpod-genomics-image18.png["Uno screenshot della scheda GPU dell'inventario di Cisco UCS Manager che mostra una scheda grafica P6 in modalità Compute"]

+
image:flexpod-genomics-image19.png["Uno screenshot di Cisco UCS Manager che mostra l'inventario delle GPU con una UCSB-GPU-P6-R in modalità Compute"]
...
. Questo comando installa  https://docs.nvidia.com/vgpu/latest/grid-software-quick-start-guide/installing-configuring-vgpu-manager-guest-driver.html#installing-the-nvidia-virtual-gpu-manager-on-vmware-vsphere["NVIDIA vGPU Manager"^] in ESXi.
+
....
...
+
image:flexpod-genomics-image20.png["Uno screenshot del vSphere Client che mostra il dispositivo grafico NVIDIA Tesla P6 configurato per Shared Direct"]

+
image:flexpod-genomics-image21.png["Uno screenshot di Edit Graphics Device Settings con Shared Direct selezionato e Restart X.Org server spuntato"]
...
+
image:flexpod-genomics-image22.png["Uno screenshot delle opzioni di avvio della VM di vCenter che mostra il firmware EFI e Secure Boot disabilitati"]
...
+
image:flexpod-genomics-image23.png["Uno screenshot che mostra la sezione Modifica impostazioni avanzate di vCenter con un collegamento Modifica configurazione"]

+
image:flexpod-genomics-image24.png["Uno screenshot della finestra di dialogo Parametri di configurazione che elenca i valori pciPassthru.64bitMMIOSizeGB e pciPassthru.use64bitMMIO"]
...
+
image:flexpod-genomics-image25.png["Uno screenshot di vCenter Edit Settings che mostra il profilo NVIDIA GRID vGPU grid_p6-16c selezionato per un dispositivo PCI"]
...
+
image:flexpod-genomics-image26.png["Uno screenshot della pagina Licensed Clients del server di licenze NVIDIA che elenca un client Ethernet virtuale"]
