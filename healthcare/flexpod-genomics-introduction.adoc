...
image:flexpod-genomics-image2.png["Un diagramma che mostra le applicazioni ospedaliere unificate su FlexPod con protocolli, storage e connettività cloud"]
