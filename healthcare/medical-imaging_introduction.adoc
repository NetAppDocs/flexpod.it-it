...
L'assistenza sanitaria, così come la conosciamo, ruota attorno a operatori sanitari (medici, infermieri, radiologi, tecnici di dispositivi medici e così via) e pazienti. Man mano che avvicini pazienti e operatori sanitari, rendendo la posizione geografica un semplice dato, diventa ancora più importante che la piattaforma sottostante sia disponibile quando operatori e pazienti ne hanno bisogno. La piattaforma deve essere sia efficiente che conveniente nel lungo termine. Nel tentativo di ridurre ulteriormente i costi dell'assistenza ai pazienti,  https://www.cms.gov/priorities-innovation-key-concepts-accountable-care-accountable-care-organizations["Organizzazioni responsabili dell'assistenza"^] (ACOs) trarrebbero vantaggio da una piattaforma efficiente.
...
* Le modalità mobili, come i dispositivi di scansione wireless portatili (ad esempio, gli scanner ecografici tascabili collegati a un telefono), richiedono un'infrastruttura di rete robusta con sicurezza, affidabilità e latenza a livello DoD ai margini, nel core e nel cloud. https://www.netapp.com/blog/medical-imaging-cloud-disaster-recovery-meets-ai/["Un data fabric abilitato da NetApp"^] fornisce alle organizzazioni questa capacità su larga scala.
* Le modalità più recenti hanno esigenze di archiviazione esponenziali; ad esempio, la TC e la risonanza magnetica richiedono alcune centinaia di MB per ciascuna modalità, ma le immagini di patologia digitale (incluse le immagini di vetrini interi) possono avere dimensioni di alcuni GB. FlexPod è progettato con https://www.netapp.com/pdf.html?item=/media/16926-sb-flexpod-advantage-performance-agility-economics.pdf["performance, affidabilità e scalabilità come caratteristiche fondamentali"^].
...
image:medical-imaging_image2.png["Un diagramma che mostra il modello di supporto cooperativo FlexPod tra clienti, Cisco e NetApp"]
