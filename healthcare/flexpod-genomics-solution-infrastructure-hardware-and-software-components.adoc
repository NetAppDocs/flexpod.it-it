...
image:flexpod-genomics-image6.png["Un diagramma che mostra FlexPod per Genomics con Cisco UCS, Nexus, MDS e NetApp AFF A700 connettività"]

Il seguente diagramma illustra i dettagli del cablaggio FlexPod.

image:flexpod-genomics-image7.png["Un diagramma che mostra il cablaggio di FlexPod per Genomics tra UCS, Nexus, NetApp AFF e gli switch MDS"]
