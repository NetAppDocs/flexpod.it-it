...
* Utilizza la tecnologia di replica basata su storage array NetApp denominata https://www.netapp.com/pdf.html?item=/media/17229-tr4015pdf.pdf["SnapMirror"^] invece della replica basata su vSphere.
