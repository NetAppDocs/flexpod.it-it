...
image:medical-imaging_image8.png["Un diagramma che mostra i nodi AFF A300 con ifgrp a0a, VLAN e LIF NFS e iSCSI"]
...
* Usa la tecnologia di replica basata su array di storage NetApp chiamata  https://www.netapp.com/pdf.html?item=/media/17229-tr4015.pdf["SnapMirror"^] invece della replica basata su vSphere.
