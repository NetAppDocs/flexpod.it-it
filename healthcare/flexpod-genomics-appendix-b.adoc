...
summary: 'Questa sezione descrive l"esecuzione dell"output ./gatk.' 
---
...
link:flexpod-genomics-appendix-a.html["Precedente: Output per l'esecuzione di GATK utilizzando il file jar."]
...
link:flexpod-genomics-appendix-c.html["Avanti: Output per l'esecuzione di GATK utilizzando il motore Cromwell."]
