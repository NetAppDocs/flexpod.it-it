...
[role="lead"]
NetApp ONTAP software è installato su tutti i sistemi NetApp FAS, AFF e ASA. FlexPod è convalidato con il software ONTAP, fornendo un'architettura di storage altamente scalabile che consente operazioni senza interruzioni, aggiornamenti senza interruzioni e un'infrastruttura dati agile.
