...
Per ulteriori informazioni sugli alloggiamenti per dischi e sui supporti di memorizzazione, consulta il collegamento "Specifiche tecniche degli alloggiamenti per dischi e dei supporti di memorizzazione" nella tabella seguente.

|===
| Shelf di dischi | Specifiche tecniche 


| DS224C .4+| https://www.netapp.com/data-storage/disk-shelves-storage-media/["Specifiche tecniche degli shelf di dischi e dei supporti di memorizzazione"] 
