...
* *FlexPod Datacenter.* Questa piattaforma è un'infrastruttura di data center virtuale massivamente scalabile adatta per applicazioni aziendali di workload, virtualizzazione, VDI e cloud pubblico e privato. FlexPod Datacenter ha le proprie specifiche, che sono documentate in https://docs.netapp.com/us-en/flexpod/fp-def/dc-tech-spec_solution_overview.html["Specifiche tecniche del data center FlexPod"^].
