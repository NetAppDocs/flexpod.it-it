...
. Scarica l'appliance virtuale Cisco Intersight da  https://software.cisco.com/download/home/286319499/type/286323047/release/1.1.7-0.a["software.cisco.com"^]. Per ulteriori informazioni, vai su  https://www.cisco.com/c/en/us/td/docs/unified_computing/Intersight/b_Cisco_Intersight_Appliance_Getting_Started_Guide/b_Cisco_Intersight_Appliance_Install_and_Upgrade_Guide_chapter_00.html["Guida all'installazione e all'aggiornamento di Intersight Appliance"^].
...
+
.. Vai su  `https://<FQDN-of-your-appliance>` per completare la configurazione post-installazione del tuo appliance.
+
