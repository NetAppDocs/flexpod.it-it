...
NOTE: Consulta  https://intersight.com/help/saas/supported_systems/overview["Sistemi supportati da Cisco Intersight"^] per i requisiti minimi dei componenti di calcolo Cisco UCS e della versione UCSM.
...
Per ulteriori informazioni sulle funzionalità incluse nei vari livelli di licenza, vai su  https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["Licenza dei servizi di infrastruttura"^].
