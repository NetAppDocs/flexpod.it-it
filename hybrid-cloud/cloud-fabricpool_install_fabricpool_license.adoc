...
image:cloud-fabricpool_image8.png["Uno screenshot della finestra di dialogo \"Add License Packages\" di OnCommand System Manager con i pulsanti \"Choose Files\" e \"Add\""]
...
image:cloud-fabricpool_image9.png["Uno screenshot dei dettagli delle licenze di ONTAP System Manager che mostra la capacità di licenza FabricPool di 10 TB e la capacità attuale di 0 Byte"]
