...
image:cloud-fabricpool_image4.png["Un diagramma che mostra la suddivisione in livelli Snapshot-Only che sposta le copie snapshot da un cluster primario al cloud storage"]
...
image:cloud-fabricpool_image5.png["Un diagramma che mostra l'Auto tiering mentre sposta i dati inattivi dallo storage primario del cluster al cloud storage"]
