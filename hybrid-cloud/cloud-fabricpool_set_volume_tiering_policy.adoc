...
. Fare clic su Salva.
+
image:cloud-fabricpool_image16.png["Uno screenshot che mostra la finestra di dialogo Modifica criteri di tiering del volume con le opzioni dei criteri di tiering espanse"]
