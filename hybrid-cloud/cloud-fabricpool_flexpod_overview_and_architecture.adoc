...
image:cloud-fabricpool_image2.png["Un diagramma che mostra lo storage FlexPod, gli switch Cisco Nexus e MDS, e le famiglie Cisco UCS con indicazioni sulla connettività"]
...
image:cloud-fabricpool_image3.png["Un diagramma che mostra le connessioni di Cisco UCS, Nexus 93180YC-EX, AFF A300 e MDS 9148S"]
