...
image:cloud-fabricpool_image6.png["Un diagramma che mostra due NetApp AFF A300 controller che collegano LIF intercluster ad AWS S3"]
...
image:cloud-fabricpool_image7.png["Uno screenshot dei risultati del profiler dell'archivio di oggetti ONTAP CLI che mostra la latenza PUT e GET e il throughput"]
...
FabricPool le licenze (inclusa la capacità aggiuntiva per le licenze esistenti) possono essere acquistate in incrementi da 1TB.
