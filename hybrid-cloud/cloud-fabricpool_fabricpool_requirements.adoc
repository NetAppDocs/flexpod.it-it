...
NOTE: Consultare il https://hwu.netapp.com/DetailViews/Home.aspx[] [NetApp Hardware Universe^] per le informazioni più recenti sulle piattaforme supportate con FabricPool.

* NetApp ONTAP Select [NOTA] NetApp consiglia di utilizzare livelli locali FabricPool interamente basati su SSD.
* Tier cloud
+
