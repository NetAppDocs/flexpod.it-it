...
image:cloud-insights_image2.png["Un diagramma che mostra Cisco UCS, switch Nexus, controller NetApp AFF A800 e switch MDS interconnessi da collegamenti di rete"]
...
* Analisi dell'ambiente con i dati forniti a NetApp Digital Advisor per la valutazione dei rischi del sistema storage e per le raccomandazioni sull'ottimizzazione dello storage.
