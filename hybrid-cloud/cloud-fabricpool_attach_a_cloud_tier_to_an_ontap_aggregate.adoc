...
+
image:cloud-fabricpool_image14.png["Uno screenshot che mostra il menu di navigazione di OnCommand System Manager con Applicazioni e livelli selezionati"]

. Fare clic su Storage Tier.
. Fare clic su un aggregato.
. Fare clic su azioni e selezionare Allega Tier cloud.
+
image:cloud-fabricpool_image15.png["Uno screenshot che mostra il menu Altre azioni con l'opzione Collega livello cloud selezionata"]
