...
image:cloud-fabricpool_image10.png["Un diagramma che mostra le configurazioni di collegamento aggregato-bucket valide e non valide di FabricPool"]
...
+
image:cloud-fabricpool_image11.png["Uno screenshot della ricerca nella console AWS che mostra il risultato S3 Scalable Storage in the Cloud evidenziato"]
...
+
image:cloud-fabricpool_image12.png["Uno screenshot della finestra di dialogo \"Create bucket\" di AWS con il nome del bucket, la regione e il pulsante \"Create\""]
