...
. Vai a https://www.netapp.com/data-infrastructure-insights/["https://www.netapp.com/data-infrastructure-insights/"^]
...
+
image:cloud-insights_image3.png["Un menu contestuale di vSphere con \"Nuova macchina virtuale\" evidenziata tra le azioni del cluster"]
...
+
image:cloud-insights_image4.png["Una screenshot della procedura guidata Seleziona un sistema operativo guest con Linux e Red Hat Enterprise Linux 7 (64-bit) selezionati"]
...
+
image:cloud-insights_image5.png["Uno screenshot di VMware Personalizza le impostazioni hardware con CPU, memoria, disco, rete e unità CD/DVD configurati"]
...
+
image:cloud-insights_image6.png["Uno screenshot del menu di boot di Red Hat Enterprise Linux 7.6 con l'opzione Installa selezionata"]
...
+
image:cloud-insights_image7.png["Uno screenshot che mostra un disco virtuale VMware da 100 GiB selezionato e l'opzione di partizionamento manuale"]
...
+
image:cloud-insights_image8.png["Uno screenshot del partizionamento manuale di Red Hat Enterprise Linux con i volumi /opt/netapp e /var/log/netapp da 25 GiB"]
...
+
image:cloud-insights_image9.png["Uno screenshot della schermata Network  Host Name di Red Hat Enterprise Linux con Ethernet abilitato e un host name inserito"]
...
+
image:cloud-insights_image10.png["Uno screenshot della schermata di completamento dell'installazione di Red Hat Enterprise Linux con un pulsante Reboot"]

. Una volta riavviato il sistema, accedere al server e registrarlo con Red Hat Subscription Manager.
+
image:cloud-insights_image11.png["Un terminale che mostra la registrazione riuscita di Red Hat Subscription Manager per il sistema Netapp-AU"]

. Allega un abbonamento disponibile per Red Hat Enterprise Linux.
+
image:cloud-insights_image12.png["Un terminale che mostra l'avvenuta connessione di un abbonamento a Red Hat Enterprise Linux"]
...
+
image:cloud-insights_image14.png["Uno screenshot che mostra le schede Collettori di dati e Unità di acquisizione, con Unità di acquisizione selezionata"]

. Per creare una nuova unità di acquisizione, fare clic sul pulsante a destra.
+
image:cloud-insights_image15.png["Uno screenshot che mostra il pulsante Aggiungi unità di acquisizione e un campo Filtro"]
...
+
image:cloud-insights_image16.png["Uno screenshot che mostra le istruzioni di installazione di Cloud Insights Linux Acquisition Unit e un frammento del programma di installazione"]
...
+
image:cloud-insights_image17.png["Una finestra del terminale che mostra un comando token per installare l'unità di acquisizione Cloud Insights su Linux"]
...
+
image:cloud-insights_image18.png["Un terminale che mostra l'avvenuta installazione e registrazione di NetApp Cloud Insights Acquisition Unit"]
...
+
image:cloud-insights_image19.png["Uno screenshot del riepilogo dell'unità di acquisizione NetApp-AU che mostra IP, stato OK e ultimo orario di segnalazione"]
...
+
image:cloud-insights_image20.png["Uno screenshot che mostra le opzioni di data collector ONTAP filtrate nella pagina Aggiungi Data Collector"]
...
+
image:cloud-insights_image21.png["Uno screenshot della pagina Configura Collector con credenziali ONTAP validate e impostazioni dell'Acquisition Unit"]
...
+
image:cloud-insights_image22.png["Uno screenshot di una riga del raccoglitore di dati di Cloud Insights che mostra lo stato del polling di FlexPod Datacenter"]
