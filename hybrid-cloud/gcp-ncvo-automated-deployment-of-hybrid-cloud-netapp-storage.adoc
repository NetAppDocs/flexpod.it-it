...
https://github.com/ucs-compute-solutions/cvo_snapmirror["Questo link GitHub"^] fornisce la configurazione Terraform con varie risorse. Puoi effettuare un fork di questo repository e crearne una copia nel tuo GitHub account.
