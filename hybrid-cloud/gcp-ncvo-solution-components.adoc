...
Maggiori informazioni sulle licenze Intersight e sulle funzionalità supportate da ciascuna licenza sono disponibili https://intersight.com/help/saas/getting_started/licensing_requirements/lic_infra["qui"^].
...
Dopo aver registrato Intersight Assist in Intersight, puoi registrare i dispositivi endpoint utilizzando l'opzione "Registra tramite Intersight Assist". Per ulteriori informazioni, vedi  https://intersight.com/help/saas/getting_started/overview["Per iniziare"^].
