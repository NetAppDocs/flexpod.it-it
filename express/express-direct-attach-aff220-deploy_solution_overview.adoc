...
image:express-direct-attach-aff220-deploy_image2.png["Un diagramma che confronta le soluzioni FlexPod Express, FlexPod Datacenter e FlexPod Select"]
...
image:express-direct-attach-aff220-deploy_image3.png["Un diagramma che mostra i server FlexPod Express, gli switch Nexus e il cablaggio di storage AFF per la gestione, i dati, l'IP, l'interconnessione del cluster e le reti peer vPC."]
