...
+
image:express-c-series-aff220-deploy_image41.png["Uno screenshot della pagina Host VMware ESXi con il pulsante Ottieni vCenter Server evidenziato"]
...
+
image:express-c-series-aff220-deploy_image42.png["Uno screenshot della selezione del tipo di distribuzione vCenter Server Appliance con Embedded Platform Services Controller selezionato"]
...
+
image:express-c-series-aff220-deploy_image43.png["Uno screenshot della pagina di destinazione della distribuzione dell'appliance vCenter Server con i campi host ESXi, porta, utente root e password"]
...
+
image:express-c-series-aff220-deploy_image44.png["Uno screenshot della pagina \"Set up appliance VM\" con i campi VM name e root password"]

. Selezionare la dimensione di implementazione più adatta al proprio ambiente. Fare clic su Avanti.
+
image:express-c-series-aff220-deploy_image45.png["Uno screenshot della pagina delle dimensioni di distribuzione del server vCenter con le opzioni di storage Tiny e Default selezionate"]

. Selezionare il datastore infra_datastore_1. Fare clic su Avanti.
+
image:express-c-series-aff220-deploy_image46.png["Uno screenshot della pagina di selezione del datastore del programma di installazione del server vCenter con infra_datastore_1 selezionato"]
...
+
image:express-c-series-aff220-deploy_image47.png["Uno screenshot di vCenter Server Appliance Installer configura le impostazioni di rete con i campi IPv4 statici compilati"]
...
+
image:express-c-series-aff220-deploy_image48.png["Uno screenshot della pagina di introduzione alla Fase 2 dell'appliance vCenter Server con un pulsante Next"]
