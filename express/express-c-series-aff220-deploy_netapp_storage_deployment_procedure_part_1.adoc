...
+
image:express-c-series-aff220-deploy_image6.png["Uno screenshot dei campi di configurazione del cluster di System Manager Guided Setup per due nodi di una coppia HA e licenze"]
...
+
image:express-c-series-aff220-deploy_image7.png["Uno screenshot della configurazione del supporto di OnCommand System Manager con i campi AutoSupport e di notifica degli eventi"]
