...
+
image:express-c-series-c190-deploy_image4.png["Uno screenshot della configurazione del supporto di OnCommand System Manager con i campi AutoSupport e di notifica degli eventi"]
