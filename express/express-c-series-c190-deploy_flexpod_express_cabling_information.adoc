...
image:express-c-series-c190-deploy_image3.png["Un diagramma che mostra le viste posteriori di due switch Nexus, due server Cisco UCS e controller AFF C190"]
