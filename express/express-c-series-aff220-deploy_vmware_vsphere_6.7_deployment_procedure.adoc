...
+
image:express-c-series-aff220-deploy_image21.png["Uno screenshot della pagina del BIOS del server Cisco CIMC con il collegamento \"Launch KVM\" nel menu in alto"]
...
+
image:express-c-series-aff220-deploy_image22.png["Uno screenshot del programma di installazione di ESXi che seleziona un dispositivo di storage NETAPP LUN C-Mode con una capacità di 15,00 GiB"]
...
+
image:express-c-series-aff220-deploy_image23.png["Uno screenshot del menu Schede di rete di ESXi con vmnic0 e vmnic1 selezionati per vSwitch0"]
...
+
image:express-c-series-aff220-deploy_image24.png["Uno screenshot della scheda Switch virtuali di rete ESXi che mostra vSwitch0 e iScsiBootvSwitch"]
...
** Fare clic su Crea.
+
image:express-c-series-aff220-deploy_image25.png["Uno screenshot del modulo Aggiungi VMkernel NIC che configura iScsiBootPG-B con impostazioni IPv4 statiche e MTU 9000"]
...
+
image:express-c-series-aff220-deploy_image26.png["Uno screenshot della pagina Adattatori di storage di VMware ESXi con l'adattatore software iSCSI vmhba64 selezionato"]

. In Dynamic Targets (destinazioni dinamiche), fare clic su Add Dynamic Target (Aggiungi destinazione dinamica
+
image:express-c-series-aff220-deploy_image27.png["Uno screenshot della finestra di dialogo Configura iSCSI con Aggiungi destinazione dinamica sotto Destinazioni dinamiche"]
...
+
image:express-c-series-aff220-deploy_image28.png["Uno screenshot che mostra quattro indirizzi IP target iSCSI dinamici, ciascuno che utilizza la porta 3260"]
...
+
image:express-c-series-aff220-deploy_image29.png["Uno screenshot della pagina VMware ESXi vSwitch0 che mostra MTU 1500 e due adattatori fisici attivi"]
...
+
image:express-c-series-aff220-deploy_image30.png["Uno screenshot della pagina Networking di ESXi con la scheda Port groups selezionata e Add port group disponibile"]
...
+
image:express-c-series-aff220-deploy_image31.png["Uno screenshot della scheda Networking VMkernel NICs di ESXi che elenca gli adattatori vmk0 e vmk1"]
...
** Fare clic su Crea.
+
image:express-c-series-aff220-deploy_image32.png["Uno screenshot del modulo Aggiungi VMkernel NIC che configura il gruppo di porte NFS-Network con impostazioni IPv4 statiche"]
...
+
image:express-c-series-aff220-deploy_image33.png["Uno screenshot della finestra di dialogo Aggiungi VMkernel NIC con impostazioni IPv4 statiche e vMotion selezionato"]
...
+
image:express-c-series-aff220-deploy_image34.png["Uno screenshot della pagina VMware ESXi Storage con il pulsante Nuovo datastore visibile"]

. Selezionare Mount NFS Datastore (monta archivio dati NFS).
+
image:express-c-series-aff220-deploy_image35.png["Uno screenshot della procedura guidata Nuovo datastore con Monta NFS datastore selezionato come tipo di creazione"]
...
+
image:express-c-series-aff220-deploy_image36.png["Uno screenshot della pagina Gestione data e ora di sistema di ESXi che mostra lo stato del client NTP e i server NTP"]
...
. Fare clic su Salva.
+
image:express-c-series-aff220-deploy_image37.png["Uno screenshot della finestra di dialogo Modifica configurazione ora con NTP abilitato e un server NTP inserito"]
...
+
image:express-c-series-aff220-deploy_image38.png["Uno screenshot della pagina Gestione swap di sistema di VMware ESXi con le impostazioni di swap visualizzate"]

. Fare clic su Modifica impostazioni. Selezionare infra_swap dalle opzioni Datastore.
+
image:express-c-series-aff220-deploy_image39.png["Uno screenshot della finestra di dialogo Modifica configurazione swap con infra_swap selezionato come datastore e i pulsanti Save e Cancel"]
...
+
image:express-c-series-aff220-deploy_image40.png["Un terminale che mostra l'installazione del VIB del plug-in NFS di NetApp avvenuta con successo e un messaggio che indica che è necessario riavviare il sistema"]
