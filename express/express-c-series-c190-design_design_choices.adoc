...
image:express-c-series-c190-design_image4.png["Un diagramma che mostra la vista posteriore di due controller AFF C190 con porte UTA 2 per moduli SFP+"]

La figura seguente illustra le porte 10GBASE-T per il collegamento tramite cavi Ethernet RJ-45 convenzionali.

image:express-c-series-c190-design_image5.png["Schema che mostra il pannello posteriore di un sistema AFF C190 con porte RJ-45 10GBASE-T"]
...
Per informazioni complete sul sistema hardware AFF C190, consulta la  https://docs.netapp.com/us-en/ontap-systems/c190/install-setup.html["NetApp AFF C190 documentazione"^].
...
image:express-c-series-c190-design_image6.png["Un diagramma che mostra più blocchi logici da 4KB compattati in un unico blocco fisico da 4KB"]
...
image:express-c-series-c190-design_image7.png["Vista frontale di uno switch Cisco Nexus 31108PC-V con 48 porte SFP+ e sei porte QSFP28"]
...
image:express-c-series-c190-design_image8.png["Vista frontale di un server rack Cisco UCS C220 M5 con due alloggiamenti per unità disco e marchio Cisco"]
...
image:express-c-series-c190-design_image9.png["Uno screenshot dell'adattatore Cisco UCS VIC 1457 con quattro porte SFP28 e una ventola di raffreddamento"]
...
image:express-c-series-c190-design_image10.png["Un diagramma che mostra quattro vNIC collegate a FlexPod e agli vSwitches di avvio iSCSI su un host VMware ESXi 6.7 U2"]
