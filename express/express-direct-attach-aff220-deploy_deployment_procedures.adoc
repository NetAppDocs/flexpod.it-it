...
Segui le procedure di installazione fisica per i controller nel  https://docs.netapp.com/us-en/ontap-systems/a220/install-setup.html["Documentazione di AFF A220"^].
...
+
image:express-direct-attach-aff220-deploy_image7.png["Uno screenshot della finestra di dialogo Crea blocco di indirizzi IPv4 con i campi indirizzo IP, subnet, gateway e DNS"]
...
+
image:express-direct-attach-aff220-deploy_image8.png["Uno screenshot della finestra di dialogo Aggiungi NTP Server con NTP Server impostato su 10.1.156.4"]

. Fare clic su Aggiungi server NTP.
. Invio `<switch-b-ntp-ip>` `or <Nexus-B-mgmt-IP>` E fare clic su OK. Fare clic su OK nella conferma.
+
image:express-direct-attach-aff220-deploy_image9.png["Uno screenshot delle impostazioni NTP di Cisco UCS Manager con due server NTP elencati e il fuso orario America/New_York selezionato"]
...
+
image:express-direct-attach-aff220-deploy_image10.png["Uno screenshot che mostra le porte Ethernet di Fabric Interconnect A con i ruoli di uplink e appliance storage configurati"]
...
+
image:express-direct-attach-aff220-deploy_image11.png["Uno screenshot che mostra le porte Ethernet di Fabric Interconnect B con i ruoli di rete e di storage appliance configurati"]
...
. Fare clic su Avanti.
+
image:express-direct-attach-aff220-deploy_image12.png["Uno screenshot della finestra di dialogo Create Port Channel con ID 1 e nome vPC-13-Nexus inseriti"]
...
+
image:express-direct-attach-aff220-deploy_image13.jpeg["Uno screenshot della finestra di dialogo Crea VLAN con NFS-VLAN e VLAN ID 3170 inseriti"]
...
. Fare clic su OK, quindi nuovamente su OK per creare la VLAN.
+
image:express-direct-attach-aff220-deploy_image14.png["Uno screenshot che mostra la tabella delle VLAN in Cisco UCS Manager con i nomi e gli ID delle VLAN"]
...
+
image:express-direct-attach-aff220-deploy_image15.png["Uno screenshot che mostra la policy di controllo di rete Enable_CDP con trasmissione e ricezione CDP e LLDP abilitate"]
...
+
image:express-direct-attach-aff220-deploy_image16.png["Uno screenshot delle proprietà dell'interfaccia Appliance 1/3 con CDP abilitato e VLAN di storage selezionate"]
...
+
image:express-direct-attach-aff220-deploy_image17.png["Uno screenshot delle impostazioni VLAN di Appliance Interface 1/3 con iSCSI-B, NFS e VLAN Native selezionate"]
...
+
image:express-direct-attach-aff220-deploy_image18.png["Uno screenshot delle impostazioni della classe di sistema QoS di Cisco UCS Manager con Best Effort MTU impostato su 9216"]
...
+
image:express-direct-attach-aff220-deploy_image19.png["Uno screenshot della finestra di dialogo Modifica versioni pacchetto con Blade Package 4.0(1b)B selezionato"]
...
+
image:express-direct-attach-aff220-deploy_image20.png["Uno screenshot della finestra di dialogo Crea un blocco di indirizzi MAC con indirizzo MAC 00:25:B5:32:0A:00 e dimensione 64"]
...
+
image:express-direct-attach-aff220-deploy_image21.png["Uno screenshot della finestra di dialogo Create a Block of IQN Suffixes con suffisso ucs-host, From 1 e Size 16"]
...
+
image:express-direct-attach-aff220-deploy_image22.png["Uno screenshot della finestra di dialogo Crea criteri di controllo di rete con CDP e LLDP abilitati"]
...
+
image:express-direct-attach-aff220-deploy_image23.png["Uno screenshot della finestra di dialogo Create Power Control Policy con No-Power-Cap e No Cap selezionati"]
...
+
image:express-direct-attach-aff220-deploy_image24.png["Screenshot della finestra di dialogo \"Create CPU/Cores Qualification\" di Cisco UCS Manager con architettura del processore Xeon e campo CPU PID"]
...
+
image:express-direct-attach-aff220-deploy_image25.png["Uno screenshot della finestra di dialogo Crea BIOS Policy con nome VM-Host e denominazione coerente dei dispositivi abilitati"]
...
+
image:express-direct-attach-aff220-deploy_image26.png["Uno screenshot della scheda Crea criteri BIOS Processore con Processor C State e C1E disabilitati"]
...
+
image:express-direct-attach-aff220-deploy_image27.png["Uno screenshot che mostra le opzioni del processore del BIOS con Energy Performance e DRAM Clock Throttling impostati su performance"]
...
+
image:express-direct-attach-aff220-deploy_image28.png["Uno screenshot della pagina Create BIOS Policy RAS Memory con la modalità LV DDR impostata su Performance Mode"]
...
+
image:express-direct-attach-aff220-deploy_image29.png["Uno screenshot della policy di manutenzione predefinita di Cisco UCS Manager con \"User Ack\" e \"On Next Boot\" selezionati"]
...
. Fare clic su OK.
+
image:express-direct-attach-aff220-deploy_image30.png["Uno screenshot delle proprietà del modello vNIC di Cisco UCS Manager per vNIC_Template_A su Fabric A"]
...
. Fare clic su OK.
+
image:express-direct-attach-aff220-deploy_image31.png["Uno screenshot delle impostazioni del modello vNIC B di Cisco UCS Manager con Fabric B, MTU 9000 e MAC Pool B selezionati"]
...
. Fare clic su OK.
+
image:express-direct-attach-aff220-deploy_image32.png["Uno screenshot del modello vNIC Site_01_iSCSI-A con Fabric A, MTU 9000 e MAC Pool A56/64 selezionati"]
...
. Fare clic su OK.
+
image:express-direct-attach-aff220-deploy_image33.png["Screenshot delle impostazioni del modello vNIC Site_01_iSCSI-B di Cisco UCS Manager per Fabric B con MTU 9000"]
...
+
image:express-direct-attach-aff220-deploy_image34.png["Uno screenshot che mostra la finestra di dialogo Modify vNIC per Site-01-vNIC-A usando vNIC_Template_A e VMWare adapter policy"]
...
+
image:express-direct-attach-aff220-deploy_image35.png["Uno screenshot della finestra di dialogo Modifica iSCSI vNIC per Site-01-iSCSI-A con impostazioni VLAN e indirizzo MAC"]
...
. Fare clic su Salva modifiche.
+
image:express-direct-attach-aff220-deploy_image36.png["Uno screenshot del criterio di connettività LAN Site-01-iSCSIBoot con due vNIC iSCSI elencate"]
...
+
Questa ISO di VMware ESXi 6.7U1 può essere scaricata da  https://support.broadcom.com/group/ecx/downloads["Portale di supporto Broadcom"^].
...
+
image:express-direct-attach-aff220-deploy_image37.png["Uno screenshot della finestra di dialogo Crea vMedia Mount configurata con un file ISO di installazione HTTP di ESXi e relativo percorso"]
...
+
image:express-direct-attach-aff220-deploy_image38.png["Uno screenshot di Cisco UCS Manager Boot Policy Site-01-Fabric-A con due voci di avvio iSCSI configurate"]
...
+
image:express-direct-attach-aff220-deploy_image39.png["Uno screenshot della procedura guidata Crea modello di profilo di servizio con i campi nome, aggiornamento modello e pool UUID"]
...
+
image:express-direct-attach-aff220-deploy_image40.png["Uno screenshot delle impostazioni di rete di Create Service Profile Template con connettività iSCSI-Boot e IQN_Pool selezionato"]
...
+
image:express-direct-attach-aff220-deploy_image41.png["Uno screenshot della pagina Crea modello profilo di servizio Ordine di avvio del server con Boot-Fabric-A selezionato"]
...
+
image:express-direct-attach-aff220-deploy_image42.png["Uno screenshot dell'output del comando iscsi show che elenca un target Infra-SVM IQN, alias e stato attivo"]

. Immettere l'indirizzo IP di `iscsi_lif_02a` Per il campo IPv4 Address (Indirizzo IPv4).
+
image:express-direct-attach-aff220-deploy_image43.png["Uno screenshot della finestra di dialogo Crea destinazione statica iSCSI con indirizzo IPv4 192.168.10.62 inserito"]
...
+
image:express-direct-attach-aff220-deploy_image44.png["Uno screenshot della finestra di dialogo Crea destinazione statica iSCSI con indirizzo IPv4 192.168.10.61 e ID LUN 0"]

. Fare clic su OK per aggiungere la destinazione statica iSCSI.
+
image:express-direct-attach-aff220-deploy_image45.png["Uno screenshot della finestra di dialogo \"Imposta parametri di avvio iSCSI\" con le interfacce di destinazione statiche iSCSI selezionate"]
...
+
image:express-direct-attach-aff220-deploy_image46.png["Uno screenshot della finestra di dialogo Create iSCSI Static Target con indirizzo IPv4 impostato su 192.168.20.62"]
...
+
image:express-direct-attach-aff220-deploy_image47.png["Uno screenshot della finestra di dialogo Crea destinazione statica iSCSI con indirizzo IPv4 192.168.20.61 e ID LUN 0"]

. Fare clic su OK per aggiungere la destinazione statica iSCSI.
+
image:express-direct-attach-aff220-deploy_image48.png["Uno screenshot che mostra due interfacce di destinazione statiche iSCSI selezionate in Imposta iSCSI Boot Parameters"]
...
+
image:express-direct-attach-aff220-deploy_image49.png["Uno screenshot della fase \"Create Service Profile Template Maintenance Policy\" con la policy predefinita selezionata"]
...
+
image:express-direct-attach-aff220-deploy_image50.png["Uno screenshot di Creazione dell'assegnazione del server del modello di profilo di servizio con Infra-Pool, stato di alimentazione Down e pacchetto firmware predefinito selezionati"]
...
+
image:express-direct-attach-aff220-deploy_image51.png["Uno screenshot della pagina Criteri operativi di Create Service Profile Template con VM-Host BIOS e No-Power-Cap selezionati"]
...
+
image:express-direct-attach-aff220-deploy_image52.png["Uno screenshot della finestra di dialogo Crea profili di servizio da modello con prefisso Site-01-Infra-0, numero 2 e organizzazione radice"]
...
. Accedi al sito di download del portale di supporto Broadcom: https://support.broadcom.com/group/ecx/downloads["https://support.broadcom.com/group/ecx/downloads"^].
. Avrai bisogno di un ID utente e di una password Broadcom. Cerca le ISO personalizzate di VMware vSphere Hypervisor (ESXi).
. Scarica l'immagine personalizzata Cisco per ESXi 6.7U1 Install CD.
...
. Premere Invio.
+
image:express-direct-attach-aff220-deploy_image53.png["Uno screenshot della schermata Schede di rete di ESXi con vmnic0 e vmnic1 selezionati e connessi"]
...
+
image:express-direct-attach-aff220-deploy_image54.png["Uno screenshot che mostra i dettagli e la topologia di vSwitch0 con gli adattatori VMkernel e due adattatori fisici"]
...
+
image:express-direct-attach-aff220-deploy_image55.png["Uno screenshot della scheda VMkernel NICs di ESXi che elenca cinque adattatori VMkernel e i loro gruppi di porte"]
...
+
image:express-direct-attach-aff220-deploy_image56.png["Uno screenshot della scheda Adattatori di archiviazione di ESXi con l'adattatore software iSCSI vmhba64 selezionato"]
...
+
image:express-direct-attach-aff220-deploy_image57.png["Uno screenshot della finestra di dialogo Configura iSCSI che mostra quattro destinazioni iSCSI dinamiche e statiche sulla porta 3260"]
...
+
image:express-direct-attach-aff220-deploy_image58.png["Uno screenshot della procedura guidata Nuovo datastore con Monta NFS datastore selezionato come tipo di creazione"]
...
.. Fare clic su Avanti.
+
image:express-direct-attach-aff220-deploy_image59.png["Uno screenshot della pagina \"Fornisci dettagli di montaggio NFS\" con infra_datastore_1 e server NFS 192.168.104.3"]
...
. Fare clic su fine. Il datastore dovrebbe ora apparire nell'elenco datastore.
+
image:express-direct-attach-aff220-deploy_image60.jpeg["Uno screenshot dell'elenco dei datastore di storage di ESXi che mostra infra_datastore_2 montato come datastore NFS"]
...
+
image:express-direct-attach-aff220-deploy_image61.png["Uno screenshot della finestra di dialogo Modifica configurazione ora con NTP abilitato e due indirizzi di server NTP inseriti"]
...
+
image:express-direct-attach-aff220-deploy_image62.png["Uno screenshot della pagina Gestisci swap di sistema di VMware ESXi che mostra le impostazioni di swap e le impostazioni di modifica"]

. Fare clic su Modifica impostazioni. Selezionare `infra_swap` Dalle opzioni Datastore.
+
image:express-direct-attach-aff220-deploy_image63.png["Uno screenshot della finestra di dialogo Modifica configurazione swap con il datastore infra_swap selezionato e i pulsanti Save e Cancel"]
...
+
image:express-direct-attach-aff220-deploy_image64.png["Uno screenshot del navigatore dell'host ESXi con il pulsante Ottieni vCenter Server evidenziato"]
...
+
image:express-direct-attach-aff220-deploy_image65.png["Uno screenshot della pagina Select deployment type del programma di installazione dell'appliance vCenter Server con l'opzione Embedded Platform Services Controller selezionata"]
...
+
image:express-direct-attach-aff220-deploy_image66.png["Uno screenshot della pagina di destinazione della distribuzione dell'appliance di installazione di VCenter Server Appliance con le credenziali dell'host ESXi inserite"]
...
+
image:express-direct-attach-aff220-deploy_image67.png["Uno screenshot della pagina Set up appliance VM del programma di installazione vCenter Server Appliance, con i campi nome VM e password di root"]

. Selezionare la dimensione di implementazione più adatta al proprio ambiente. Fare clic su Avanti.
+
image:express-direct-attach-aff220-deploy_image68.png["Uno screenshot della pagina Seleziona la dimensione di distribuzione di vCenter Server Appliance Installer con Tiny selezionato"]

. Selezionare `infra_datastore_1` datastore. Fare clic su Avanti.
+
image:express-direct-attach-aff220-deploy_image69.png["Uno screenshot della pagina Seleziona datastore di vCenter Server Appliance Installer con infra_datastore_1 elencato tra tre datastore"]
...
+
image:express-direct-attach-aff220-deploy_image70.png["Uno screenshot della pagina di configurazione delle impostazioni di rete del programma di installazione dell'appliance vCenter Server con dettagli IPv4 statici"]
...
+
image:express-direct-attach-aff220-deploy_image71.png["Uno screenshot che mostra l'avvenuta distribuzione del server vCenter di Stage 1 con un pulsante Continua"]
...
. Fare clic su OK.
+
image:express-direct-attach-aff220-deploy_image72.png["Uno screenshot della finestra di dialogo Nuovo cluster con DRS e vSphere HA abilitati per il cluster Express"]
...
+
image:express-direct-attach-aff220-deploy_image73.png["Uno screenshot del menu Azioni del client vSphere per il cluster Express con l'opzione Aggiungi host selezionata"]
