...
+
image:express-c-series-c190-deploy_image17.png["Uno screenshot della pagina del BIOS del server Cisco CIMC con il collegamento \"Launch KVM\" nel menu in alto"]
...
+
image:express-c-series-c190-deploy_image18.png["Uno screenshot del programma di installazione di ESXi che seleziona un dispositivo di storage NETAPP LUN C-Mode con una capacità di 15,00 GiB"]
...
+
image:express-c-series-c190-deploy_image19.png["Uno screenshot della schermata Schede di rete di ESXi con vmnic2 e vmnic4 selezionati per il networking di gestione"]
...
+
image:express-c-series-c190-deploy_image20.png["Uno screenshot della pagina Networking di ESXi con la scheda Switch virtuali che mostra vSwitch0 e iScsiBootvSwitch"]
...
+
image:express-c-series-c190-deploy_image21.png["Uno screenshot delle impostazioni di teaming e failover di iSCSIBootPG-A con vmnic3 attivo e vmnic5 non utilizzato"]
...
+
image:express-c-series-c190-deploy_image22.png["Uno screenshot della scheda Adattatori di archiviazione di ESXi con l'adattatore software iSCSI vmhba64 selezionato"]

. In Dynamic Targets (destinazioni dinamiche), fare clic su Add Dynamic Target (Aggiungi destinazione dinamica
+
image:express-c-series-c190-deploy_image23.png["Uno screenshot che mostra i target dinamici iSCSI con quattro indirizzi IP e la porta 3260 configurati"]
...
+
image:express-c-series-c190-deploy_image24.png["Uno screenshot di quattro indirizzi target dinamici iSCSI che utilizzano la porta 3260 e il pulsante Salva configurazione"]
...
+
image:express-c-series-c190-deploy_image25.png["Uno screenshot della pagina vSwitch0 di ESXi che mostra MTU 9000 e gli adattatori vmnic2 e vmnic4 attivi"]
...
+
image:express-c-series-c190-deploy_image26.png["Uno screenshot della pagina Networking di ESXi con la scheda Port groups selezionata e Add port group disponibile"]
...
+
image:express-c-series-c190-deploy_image27.png["Uno screenshot della scheda Networking VMkernel NICs di ESXi che elenca le interfacce vmk0 e vmk1"]
...
+
image:express-c-series-c190-deploy_image28.png["Uno screenshot della finestra di dialogo Aggiungi VMkernel NIC con impostazioni IPv4 statiche e vMotion selezionato"]
...
+
image:express-c-series-c190-deploy_image29.png["Uno screenshot della pagina VMware ESXi Storage con il pulsante Nuovo datastore visibile"]

. Selezionare Mount NFS Datastore (monta archivio dati NFS).
+
image:express-c-series-c190-deploy_image30.png["Uno screenshot della procedura guidata Nuovo datastore con Monta NFS datastore selezionato come tipo di creazione"]
...
. Fare clic su Salva.
+
image:express-c-series-c190-deploy_image31.png["Uno screenshot che mostra le impostazioni di data e ora di ESXi con il servizio NTP in esecuzione e tre server NTP"]
...
+
image:express-c-series-c190-deploy_image32.png["Uno screenshot della pagina Gestione swap di sistema di VMware ESXi con le impostazioni di swap visualizzate"]

. Fare clic su Modifica impostazioni. Selezionare `infra_swap` Dalle opzioni Datastore.
+
image:express-c-series-c190-deploy_image33.png["Uno screenshot della finestra di dialogo Modifica configurazione swap con infra_swap selezionato come datastore e i pulsanti Save e Cancel"]
