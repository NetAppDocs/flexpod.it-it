...
Per ulteriori informazioni sul sistema hardware AFF A220, consulta la  https://www.netapp.com/aff-a-series/["Pagina principale di AFF A-Series"^].
...
image:express-c-series-aff220-design_image5.png["Un diagramma che mostra più blocchi logici da 4KB compattati in un unico blocco fisico da 4KB"]
...
image:express-c-series-aff220-design_image6.png["Un diagramma che mostra i dischi partizionati in partizioni root, Controller 1 e Controller 2"]

Queste sono solo alcune delle caratteristiche principali che completano la soluzione FlexPod Express. Per dettagli sulle funzionalità aggiuntive di ONTAP 9.4, vedi la  https://www.netapp.com/pdf.html?item=/media/7413-ds-3231-ontap-unified-data-storage-management.pdf["Scheda informativa sul software di gestione dei dati ONTAP 9"^]. Vedi anche la NetApp  http://docs.netapp.com/ontap-9/index.jsp["Centro documentazione di ONTAP 9"^], che è stata aggiornata per includere ONTAP 9.4.
...
image:express-c-series-aff220-design_image7.png["Uno screenshot che mostra la vista frontale di uno switch Cisco Nexus 3172 con porte di rete"]
...
image:express-c-series-aff220-design_image8.png["Vista frontale di un server rack Cisco UCS C220 M5 con due alloggiamenti per unità disco e marchio Cisco"]
...
image:express-c-series-aff220-design_image9.png["Una scheda adattatore Cisco UCS VIC 1387 con due porte QSFP+ e una ventola di raffreddamento"]
...
image:express-c-series-aff220-design_image10.png["Fotografia di un modulo adattatore Cisco CVR-QSFP-SFP10G da QSFP a SFP"]
