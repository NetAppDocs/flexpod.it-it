...
image:express-c-series-aff220-deploy_image5.png["Un diagramma che mostra gli switch Cisco Nexus, i server Cisco UCS e i controller NetApp AFF A220 con porte 10GbE evidenziate"]
