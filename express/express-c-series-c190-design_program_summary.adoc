...
image:express-c-series-c190-design_image1.png["Un diagramma che confronta le implementazioni dipartimentali di FlexPod Express con i carichi di lavoro mission-critical di FlexPod Datacenter"]
...
image:express-c-series-c190-design_image2.png["Un diagramma che mostra le opzioni hardware di archiviazione, switch e server FlexPod Express"]
...
image:express-c-series-c190-design_image3.png["Un diagramma che mostra gli switch FlexPod Express, i server C220 M5 e le connessioni di storage AFF C190"]
