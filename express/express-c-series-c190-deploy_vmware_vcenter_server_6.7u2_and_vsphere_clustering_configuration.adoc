...
. Vai a  `+https://<<FQDN or IP of vCenter>>/vsphere-client/+`.
...
. Fare clic su OK.
+
image:express-c-series-c190-deploy_image45.png["Uno screenshot della finestra di dialogo Nuovo cluster con DRS e vSphere HA abilitati e vSAN disabilitato"]
...
+
image:express-c-series-c190-deploy_image46.png["Uno screenshot della procedura guidata Aggiungi host del client vSphere con un campo di immissione FQDN host e il pulsante Avanti"]
...
. Accedi a  `https://<vCenter IP>:5480`, inserisci root come nome utente e inserisci la password di root.
...
+
image:express-c-series-c190-deploy_image47.png["Uno screenshot di Appliance Management Services con VMware vSphere ESXi Dump Collector selezionato e Avvia disponibile"]
...
+
image:express-c-series-c190-deploy_image48.png["Un terminale che mostra i comandi di configurazione di coredump di ESXi e la verifica del server netdump"]
