...
image:express-c-series-aff220-design_image2.png["Un diagramma che mostra FlexPod Express, Datacenter e Select con le relative implementazioni e componenti di destinazione"]
