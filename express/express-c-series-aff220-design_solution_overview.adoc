...
image:express-c-series-aff220-design_image3.png["Un diagramma che mostra le famiglie di hardware FlexPod Express per storage, switching e calcolo con opzioni di configurazione"]
...
image:express-c-series-aff220-design_image4.png["Un diagramma che mostra la connettività degli switch Cisco Nexus 3172P, dei server UCS C220 M5 e dello storage AFF A220"]
