...
image:express-c-series-aff220-deploy_image3.png["Un diagramma che confronta le soluzioni FlexPod Express, Datacenter e Select, i target e i componenti dell'infrastruttura"]
...
image:express-c-series-aff220-deploy_image4.png["Un diagramma che mostra la connettività degli switch Cisco Nexus 3172P, dei server UCS C220 M5 e dello storage AFF A220"]
