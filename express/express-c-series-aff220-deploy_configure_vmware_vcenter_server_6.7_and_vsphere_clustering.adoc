...
. Fare clic su OK.
+
image:express-c-series-aff220-deploy_image49.png["Uno screenshot della finestra di dialogo Nuovo cluster con DRS e vSphere HA abilitati per cluster Tiger3"]
...
+
image:express-c-series-aff220-deploy_image50.png["Uno screenshot del vSphere Web Client che mostra il menu Azioni del cluster FlexPod con Aggiungi host selezionato"]
