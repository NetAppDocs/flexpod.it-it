...
+
image:express-c-series-c190-deploy_image5.png["Uno screenshot che mostra la schermata di avvio di un server Cisco che invita a premere F8 per la configurazione di CIMC"]
...
+
image:express-c-series-c190-deploy_image6.png["Uno screenshot delle proprietà della scheda di rete dell'utility di configurazione Cisco IMC con scheda di rete dedicata e nessuna ridondanza selezionata"]
...
+
image:express-c-series-c190-deploy_image7.png["Uno screenshot della pagina \"Configure Boot Order\" del BIOS del Cisco Integrated Management Controller"]
...
+
image:express-c-series-c190-deploy_image8.png["Uno screenshot della configurazione avanzata dell'ordine di avvio con KVM-MAPPED-DVD, iSCSI-A e iSCSI-B abilitati"]
...
+
image:express-c-series-c190-deploy_image9.png["Uno screenshot che mostra le impostazioni del BIOS CIMC con l'Option ROM degli slot PCIe 1 e 2 disabilitata"]
...
+
image:express-c-series-c190-deploy_image10.png["Uno screenshot della scheda Generale MLOM della scheda adattatore Cisco Integrated Management Controller con Port Channel deselezionato"]
...
+
image:express-c-series-c190-deploy_image11.png["Uno screenshot che mostra le impostazioni generali per la vNIC iSCSI eth1 con VLAN 3439 e porta uplink 1"]



. Selezionare la vNIC eth1 a sinistra.
+
image:express-c-series-c190-deploy_image12.png["Uno screenshot che mostra le impostazioni dell'iniziatore delle proprietà di avvio iSCSI per vNIC eth1"]
...
+
image:express-c-series-c190-deploy_image13.png["Uno screenshot delle proprietà di avvio iSCSI con initiator, dettagli della destinazione primaria e della destinazione secondaria"]
...
+
image:express-c-series-c190-deploy_image14.png["Uno screenshot che mostra le proprietà di avvio iSCSI per la vNIC eth3 con impostazioni di initiator e target"]
...
+
image:express-c-series-c190-deploy_image15.png["Uno screenshot delle proprietà della vNIC eth0 del Cisco Integrated Management Controller con MTU 9000 e VLAN predefinita 2"]

. Ripetere i passaggi 3 e 4 per eth1, verificando che la porta uplink sia impostata su 1 per eth1.
+
image:express-c-series-c190-deploy_image16.png["Uno screenshot delle vNIC di Cisco Integrated Management Controller che elenca eth0 fino a eth3 con MTU, porta uplink e impostazioni VLAN"]
