...
+
image:express-c-series-c190-deploy_image34.png["Uno screenshot della pagina del Contratto di licenza per l'utente finale di vCenter Server Appliance Installer con l'opzione di accettazione selezionata"]

. Selezionare Embedded Platform Services Controller come tipo di implementazione.
+
image:express-c-series-c190-deploy_image35.png["Uno screenshot della pagina del tipo di distribuzione vCenter Server Appliance Installer con Embedded Platform Services Controller selezionato"]
...
+
image:express-c-series-c190-deploy_image36.png["Uno screenshot del modulo di destinazione della distribuzione dell'appliance di installazione vCenter Server con le credenziali dell'host ESXi"]
...
+
image:express-c-series-c190-deploy_image37.png["Uno screenshot della pagina Set up appliance VM del programma di installazione vCenter Server Appliance, con i campi nome VM e password di root"]

. Selezionare la dimensione di implementazione più adatta al proprio ambiente. Fare clic su Avanti.
+
image:express-c-series-c190-deploy_image38.png["Uno screenshot della pagina Seleziona la dimensione di distribuzione di vCenter Server Appliance Installer con Tiny selezionato"]
...
+
image:express-c-series-c190-deploy_image39.png["Uno screenshot della pagina Configura le impostazioni di rete di vCenter Server Appliance Installer con MGMT-Network selezionata"]

. Rivedere le impostazioni nella fase 1 prima di avviare l'implementazione dell'appliance.
+
image:express-c-series-c190-deploy_image40.png["Uno screenshot della pagina di revisione delle impostazioni della fase 1 di vCenter Server Appliance Installer, pronta per il completamento."]
...
+
image:express-c-series-c190-deploy_image41.png["Uno screenshot della pagina Introduzione alla Fase 2 del vCenter Server Appliance Installer con un pulsante Next"]
...
+
image:express-c-series-c190-deploy_image42.png["Uno screenshot della configurazione SSO di Stage 2 di vCenter Server Appliance Installer con un nuovo dominio SSO selezionato"]
...
+
image:express-c-series-c190-deploy_image43.png["Uno screenshot della pagina Configura CEIP di vCenter Server Appliance Installer con l'opzione CEIP selezionata"]
...
+
image:express-c-series-c190-deploy_image44.png["Uno screenshot di un avviso di vCenter Server Appliance Installer che indica che l'installazione non può essere messa in pausa o interrotta, con i pulsanti Cancel e OK"]
