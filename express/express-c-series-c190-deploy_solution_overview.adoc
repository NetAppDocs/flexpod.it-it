...
image:express-c-series-c190-deploy_image1.png["Un diagramma che mostra le opzioni di portfolio FlexPod Express e FlexPod Datacenter con casi d'uso"]
...
image:express-c-series-c190-deploy_image2.png["Un diagramma che mostra gli switch FlexPod Express, i server C220 M5 e le connessioni di storage AFF C190"]
