...
image:flexpod-fips-image2.png["Un diagramma che mostra l'integrazione delle applicazioni aziendali che collegano i sistemi clinici e amministrativi ospedalieri"]
