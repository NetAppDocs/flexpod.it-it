...
image:flexpod-fips-image3.png["Un diagramma che mostra il flusso dei dati crittografati in scrittura e decrittografati in lettura attraverso la rete, WAFL, RAID e lo storage con un modulo crittografico"]
...
image:flexpod-fips-image4.png["Un diagramma che mostra la crittografia e la decrittografia attraverso la rete, WAFL, RAID e i livelli dei moduli crittografici di storage"]
...
image:flexpod-fips-image5.png["Un diagramma che mostra il confine crittografico di ONTAP con i componenti key manager, cryptomod e cryptomod_fips"]
